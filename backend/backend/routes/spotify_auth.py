...
_fastapi_users = FastAPIUsers[UserEntity, PydanticObjectId](
    get_user_manager=_get_user_manager,
    auth_backends=[_auth_backend],
)

spotify_oauth_router = _fastapi_users.get_oauth_router(
    _oauth_client,
    _auth_backend,
